    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <!-- Bordered Table -->
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Jurusan /</span>
                    Jurusan
                </h4>
                <div class="card">
                                ...
                                <tbody>
                                    @foreach ($jurusans as $index => $item)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a
                                                    href="{{ route('admin.jurusan.edit', $item->id) }}"class="btn btn-warning me-2"><i
                ...
                if ($('.checksAll').is(':checked')) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('admin.jurusan.delete') }}",
                                type: "DELETE",
                                data: {
                                    ids: all_ids
                                },
