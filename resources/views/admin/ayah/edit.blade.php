    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <!-- Bordered Table -->
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit Data Ayah /</span>
                    Ayah
                </h4>
                <div class="card">
                    {{-- @if (session('message'))
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin.AyahMurid.role', $ayah->id) }}" method="POST">
                                            @csrf
                    ...
                    <div class="card-body">
                        <div class="table-responsive text-nowrap">
                            <form action="{{ route('admin.AyahMurid.update', $ayah->id) }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="telepon" id="telepon" class="form-control"
                                        value="{{ str_replace('62', '0', $ayah->telepon) }}">
                                    @error('telepon')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select name="agama" id="" class="form-control">
                                        ...
                                        <option value="Kristen" {{ $ayah->agama == 'Kristen' ? 'selected' : '' }}>
                                            Kristen
                                        </option>
                                        <option value="Katolik" {{ $ayah->agama == 'Katolik' ? 'selected' : '' }}>
                                            Katolik
                                        </option>
                                        <option value="Hindu" {{ $ayah->agama == 'Hindu' ? 'selected' : '' }}>Hindu
                                        </option>
                                        <option value="Buddha" {{ $ayah->agama == 'Buddha' ? 'selected' : '' }}>Buddha
                                        </option>
                                        <option value="Konghucu" {{ $ayah->agama == 'Konghucu' ? 'selected' : '' }}>
                                            Konghucu
                                        </option>
                                        <option value="Ateis" {{ $ayah->agama == 'Ateis' ? 'selected' : '' }}>Ateis
                                        </option>
                                    </select>
                                    @error('agama')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="pendidikan" id="" class="form-control">
                                        <option selected>--Pilih--</option>
                                        <option value="SD" {{ $ayah->pendidikan == 'SD' ? 'selected' : '' }}>SD
                                            -sederajat</option>
                                        <option value="SMP" {{ $ayah->pendidikan == 'SMP' ? 'selected' : '' }}>SMP
                                            -sederajat</option>
                                        <option value="SMA" {{ $ayah->pendidikan == 'SMA' ? 'selected' : '' }}>SMA
                                            -sederajat</option>
                                        <option value="S1" {{ $ayah->pendidikan == 'S1' ? 'selected' : '' }}>S1
                                        </option>
                                        <option value="S2" {{ $ayah->pendidikan == 'S2' ? 'selected' : '' }}>S2
                                        </option>
                                        <option value="S3" {{ $ayah->pendidikan == 'S3' ? 'selected' : '' }}>S3
                                        </option>
                                    </select>
                                    @error('pendidikan')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="mb-3 col-md-6 d-flex flex-column">
                                    ...
                                    <img src="{{ asset('storage/image/' . $ayah->image) }}" alt=""
