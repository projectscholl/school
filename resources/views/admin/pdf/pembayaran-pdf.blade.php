        ...
        <table class="table table-bordered">
            ...
            <thead>
                <tr class="table-secondary">
                    ...
                    <th class="text-uppercase">NAMA MURID</th>
                    <th class="text-uppercase">July</th>
                    <th class="text-uppercase">Agustus</th>
                    <th class="text-uppercase">September</th>
                    <th class="text-uppercase">Oktober</th>
                    <th class="text-uppercase">November</th>
                    <th class="text-uppercase">Desember</th>
                    <th class="text-uppercase">January</th>
                    <th class="text-uppercase">February</th>
                    <th class="text-uppercase">Maret</th>
                    <th class="text-uppercase">April</th>
                    <th class="text-uppercase">Mei</th>
                    <th class="text-uppercase">Juni</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-danger">Rp.200.000</td>
                    <td class="text-danger">Rp.200.000</td>
                    <td class="text-danger">Rp.200.000</td>
                    <td class="text-success"><b>Sudah</b></td>
                    <td class="text-danger">Rp.200.000</td>
                    <td class="text-danger">Rp.200.000</td>
                    <td class="text-success"><b>Sudah</b></td>
                    <td class="text-danger">Rp.200.000</td>
