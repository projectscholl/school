                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.walimurid.update', $user->id) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                <label for="name" class="mb-3">Nama <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group mb-3">
                                <label for="content" class="mb-3">Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="email" id="email"
                                    placeholder="Masukkan Alamat Email" required value="{{ old('email', $user->email) }}">
                            </div>
                            <div class="form-group mb-3">
                                <label for="sebagai" class="mb-3">Sebagai <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group mb-3">
                                <label for="alamat" class="mb-3">Alamat <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="alamat" id="alamat"
                                    placeholder="Jl.Pakubumi, surakarta" value="{{ old('alamat', $user->alamat) }}">
                                @error('alamat')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                <label for="password" class="mb-3">Password <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group mb-3">
                                <label for="content" class="mb-3">Telepon <span class="text-danger">*</span></label>
