    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Ibu Murid /</span>
                    Ibu Murid
                </h4>
                <!-- Bordered Table -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive text-nowrap">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    @foreach ($ibu as $key => $ibus)
                                        <tr>
                                            <td><input type="checkbox" value="{{ $ibus->id }}" class="checksAll"
                                                    name="ids"></td>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $ibus->name }}</td>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <a href="{{ route('admin.IbuMurid.edit', $ibus->id) }}"
                                                    class="btn ms-2 btn-warning"><i class="bx bx-edit"></i></a>
                                                <form action="">
